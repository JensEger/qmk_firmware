...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_NUM] = LAYOUT(KC_NO, KC_NO, KC_TILD, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_TAB, KC_DQUO, KC_PERC, KC_LT, KC_GT, KC_COLN, KC_PPLS, KC_P7, KC_P8, KC_P9, KC_MINS, KC_NO, KC_LSFT, KC_DLR, KC_HASH, KC_LPRN, KC_RPRN, KC_AT, KC_PAST, KC_P4, KC_P5, KC_P6, KC_PSLS, KC_RSFT, KC_NO, KC_PIPE, KC_CIRC, KC_QUES, KC_EXLM, KC_PERC, KC_NO, KC_BSPC, KC_AMPR, KC_P1, KC_P2, KC_P3, KC_EQL, KC_NO, KC_NO, KC_TRNS, KC_NO, KC_PENT, KC_PDOT, KC_P0),
    [_SRT] = LAYOUT(KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, LSFT(KC_TAB), KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_HOME, KC_UP, KC_END, KC_NO, KC_NO, KC_NO, LSFT(KC_ENT), KC_LSFT, KC_NO, KC_NO, KC_NO, KC_NO, KC_LEFT, KC_DOWN, KC_RGHT, KC_NO, KC_NO, KC_NO, LCTL(KC_ENT), KC_LCTL, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_TRNS, KC_NO, LALT(KC_ENT), KC_NO),
